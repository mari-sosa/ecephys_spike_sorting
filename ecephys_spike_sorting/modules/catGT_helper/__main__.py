...
def run_CatGT(args):
   ...
   # subprocess.call(catGT_cmd)
    ...
    gate_list =  args['catGT_helper_params']['gate_list_string']

    read_catgt_runName = 'catgt_' + args['catGT_helper_params']['run_name'] + '_g' + first_gate 
    write_catgt_runName = 'catgt_' + args['catGT_helper_params']['run_name'] + '_g' + gate_list # args['catGT_helper_params']['gate_string']

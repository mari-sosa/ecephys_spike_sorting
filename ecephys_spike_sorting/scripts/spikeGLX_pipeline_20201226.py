...
logName = f"{run_file_base}_log.csv" # '20201002_MS2_log.csv'
...
run_specs = [
        [
            '20201226_C25R1_Day23_CenterRow180_TipRef_2',
            '0',
            '0,0',
            '0',
        ]
...
catGT_dest = r'/opt/handeldata/rig43/preprocessed/' + run_file_base #20201002_MS2_Day4_Bank2/'
...
json_directory = os.path.join(r'/opt/handeldata/rig43/preprocessed', run_file_base) #r'/home/rig43/local_repos/ecephys_spike_sorting/ecephys_spike_sorting/json_files'
